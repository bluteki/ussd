...
use Bluteki\Ussd\Tests\App\NextAction\NextActionDemo;
use Bluteki\Ussd\Tests\App\NextAction\NextTwoActionDemo;
use Bluteki\Ussd\Tests\TestCase;
use Bluteki\Ussd\Ussd;
use SimpleXMLElement;

class NextActionDemoTest extends TestCase
{
    public function test_navigate_response_action_demo(): void
    {
        $response_entry = (new Ussd)->execute(NextActionDemo::class, (new Request(
        ...
        $response_input = (new Ussd)->execute(NextActionDemo::class, (new Request(
            $sessionID,
            $msisdn,
        ...
        $this->assertEquals(Handler::USSD_RESPONSE_OPEN_SESSION, $response_input_data->get('type'));
        $this->assertEquals($msg, $response_input_data->get('msg'));
        ...
        $this->assertEquals(NextTwoActionDemo::INPUT_NEXT_TWO_ACTION_RESPONSE, $response_input_data->get('msg'));
    }
}